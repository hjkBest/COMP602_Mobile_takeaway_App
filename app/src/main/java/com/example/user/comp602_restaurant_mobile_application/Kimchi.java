...
public class Kimchi extends AppCompatActivity {
    ...
    public void SendOrder(){
        Intent intent = new Intent(Kimchi.this, generateQR.class); //declare new intent
        ...
        if(isclicked) {
            ...
            Intent re = new Intent(Kimchi.this, MainActivity.class);
            Toast.makeText(Kimchi.this, "No Order Received", Toast.LENGTH_LONG).show();
            startActivity(re);
        }
    }
    ...
    public void setupsendbutton(){
        Button sendMassage = (Button) findViewById(R.id.send_message2);
